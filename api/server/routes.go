...
func (s *Server) InitialiseRoutes(controller *controllers.Controller) {
	...
	s.Router.HandleFunc("/api/articles/{articleId}/comments", controller.CreateCommentHandler).Methods("POST")
	s.Router.HandleFunc("/api/articles/{articleId}/comments", controller.GetCommentsHandler).Methods("GET")
	s.Router.HandleFunc("/api/comments/{commentId}", controller.GetOneCommentHandler).Methods("GET")
